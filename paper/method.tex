...
knowing things about every ggalaxy and every PSF that are---almost in
...
challenging to deblend from the galaxy reliably.  At all angular
sizes, galaxies frequently overlap, both because galaxies are
spatially clustered and because some ``galaxies'' are really pairs of
galaxies merging.  In what follows, we won't have much to help these
matters; we deal with them more-or-less ``by hand''.
