...
galaxy, we optimize a justifiable scalar objective function that is an
...
larger than an individual \project{SDSS} frame, but we don't co-add or
mosaic he data before fitting; the fitting is perfomed on all the
individual disjoint science exposures simultaneously.  For most
...
...Sloan data; what do we use and how do we get it and what calibrations do we use?..

...Error model; what do we use and what's wrong with it?..

The primary source of for the input catalog---our source for galaxy
celestial positions---was the Third Reference Catalog of Bright
Galaxies (RC3) from which we pulled all objects which had an angular
diameter equal to or greater than 2 arcminutes as measured in the
