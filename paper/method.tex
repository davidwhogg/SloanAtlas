...
photometry also, but so long as the PSF is constant, and precise and
...
photometry does not have to get all this right so long as it deals
with it \emph{consistently}.  Not so for galaxies, each of which might
have very different correlations with the PSF at large angles.  There
is no way to produce consistent photometry without knowing things
about every ggalaxy and every PSF that are---almost in
...
In addition to all the photometric method problems, there are a large
number of separate pragmatic issues when we consider the problem of
performing photometry automatically and consistently in a large and
heterogeneous data set...deblending...superimposed stars...NSA...

...Our goals are...so we do fitting...strong endorsement of fitting here...

...Why can we live with inflexible models?...
