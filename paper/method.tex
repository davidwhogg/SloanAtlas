...
\caption{This shows the six different fields of data which are combined for the galaxy NGC 4605}
\end{figure}
\begin{figure}[]
\centering
\includegraphics[trim = 1cm 3.2cm 3.8cm 2.15cm,clip=true,width=\textwidth] {model.pdf}
\caption{This shows the model of NGC 4605 in six different fields which are combined}
\end{figure}

\begin{figure}[]
\centering
\includegraphics[trim = 1cm 3.2cm 3.8cm 2.15cm,clip=true,width=\textwidth] {diff.pdf}
\caption{This shows the difference between the data and the model}
\end{figure}
\begin{figure}[]
\centering
\includegraphics[trim = 1cm 3.2cm 3.8cm 2.15cm,clip=true,width=\textwidth] {chi.pdf}
\caption{This shows the chi values for NGC 4605}
\end{figure}
