...
\begin{figure}
\centering
\includegraphics[trim = 15mm 0mm 0mm 0mm]{method_color.pdf}
\caption{A color-color plot of our new data (black) and a comparison to NASA-Sloan data (red)}
\end{figure}

\begin{figure}
\centering
\includegraphics[trim = 15mm 0mm 0mm 0mm]{method_sb2.pdf}
\caption{Surface brightness in the i-band versus the r-i color for our data (black) and NASA-Sloan data (red)}
\end{figure}
