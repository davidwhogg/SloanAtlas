...
Galaxies (RC3) and the NASA-Sloan Atlas (NSA). We specifically
highlight some large galaxies \emph{not} included RC3.  Our sample
includes measurements of galaxies with radii as large as $\sim
208\,\arcsec$ in radius, such as the Pinwheel Galaxy(M101), while
