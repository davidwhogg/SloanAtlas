...
plt.ylabel(r"$g-i$ color (mag)")
plt.axhline(y=1.33682, color='r',label='1.33682')
plt.axhline(y=1.80399, color='r',label='1.80399')
plt.axhline(y=2.50706, color='r',label='2.50706')
plt.axvline(x=19.5282, ymin=0, ymax=.334205, color='r')
plt.axvline(x=21.0245, ymin=0, ymax=.334205, color='r')
plt.axvline(x=22.1049, ymin=0, ymax=.334205, color='r')
plt.axvline(x=18.8572, ymin=.334205, ymax=.4509975, color='r')
plt.axvline(x=19.975, ymin=.334205, ymax=.4509975, color='r')
plt.axvline(x=21.6505, ymin=.334205, ymax=.4509975, color='r')
plt.axvline(x=17.7814, ymin=.4509975, ymax=.626765,color='r')
plt.axvline(x=18.7856, ymin=.4509975, ymax=.626765,color='r')
plt.axvline(x=19.8334, ymin=.4509975, ymax=.626765,color='r')
plt.axvline(x=17.5609, ymin=.626765, ymax=4, color='r')
