...
plt.ylabel(r"$g-i$ color (mag)")
plt.axhline(y=1.32541, color='r',label='1.32541')
plt.axhline(y=1.80408, color='r',label='1.80408')
plt.axhline(y=2.52305, color='r',label='2.52305')
plt.axvline(x=19.4935, ymin=0, ymax=.3313525, color='r')
plt.axvline(x=21.0923, ymin=0, ymax=.3313525, color='r')
plt.axvline(x=22.2018, ymin=0, ymax=.3313525, color='r')
plt.axvline(x=18.913, ymin=.3313525, ymax=.45102, color='r')
plt.axvline(x=19.9893, ymin=.3313525, ymax=.45102, color='r')
plt.axvline(x=21.6505, ymin=.3313525, ymax=.45102, color='r')
plt.axvline(x=17.8609, ymin=.45102, ymax=.6307625,color='r')
plt.axvline(x=18.8264, ymin=.45102, ymax=.6307625,color='r')
plt.axvline(x=19.8873, ymin=.45102, ymax=.6307625,color='r')
plt.axvline(x=17.7214, ymin=.6307525, ymax=4, color='r')
plt.axvline(x=18.6344, ymin=.6307525, ymax=4, color='r')
plt.axvline(x=19.3015, ymin=.6307525,ymax=4, color='r')
