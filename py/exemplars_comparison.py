...
plt.xlabel(r"$u-g$")
plt.ylabel('n')
plt.plot(ug[1335],sersic[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0.5,6.1)
plt.xlabel(r"$g-r$")
plt.plot(gr[1335],sersic[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0.5,6.1)
plt.xlabel(r"$r-i$")
plt.plot(ri[1335],sersic[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0.5,6.1)
plt.xlabel(r"$i-z$")
plt.plot(iz[1335],sersic[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0.5,6.1)
plt.xlabel(r"$\mu_i$")
plt.plot(sb[1335],sersic[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.xlabel(r"$u-g$")
plt.ylabel(r"$\mu_i$")
plt.plot(ug[1335],sb[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(17,24)
plt.xlabel(r"$g-r$")
plt.plot(gr[1335],sb[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(17,24)
plt.xlabel(r"$r-i$")
plt.plot(ri[1335],sb[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(17,24)
plt.xlabel(r"$i-z$")
plt.plot(iz[1335],sb[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.xlabel(r"$u-g$")
plt.ylabel(r"$i-z$")
plt.plot(ug[1335],iz[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0,1.2)
plt.xlabel(r"$g-r$")
plt.plot(gr[1335],iz[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0,1.2)
plt.xlabel(r"$r-i$")
plt.plot(ri[1335],iz[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.xlabel(r"$u-g$")
plt.ylabel(r"$r-i$")
plt.plot(ug[1335],ri[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0.5,2.1)
plt.xlabel(r"$g-r$")
plt.plot(gr[1335],ri[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')
...
plt.ylim(0,4)
plt.ylabel(r"$g-r$")
plt.plot(ug[1335],gr[1335],'*',ms=9,markeredgecolor='red',markeredgewidth=0.9,markerfacecolor='none')

plt.savefig('exemplar33_plot3.png')
plt.show()